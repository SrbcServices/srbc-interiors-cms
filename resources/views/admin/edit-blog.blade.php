                ...
                <div class="row">
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <input type="text" value="{{ $blog->Heading }}" name="blogheading" class="form-control">
                    ...
                    <div class="col-md-6">
                        <div class="form-group mb-4">
                            ...
                            <input type="text" value="{{ $blog->Subheading }}" name="subheading" class="form-control"
                                name="subHeading">
                        </div>
                    </div>
                    ...
                    <div class="col-md-6">
                        <div class="col-md-3">
                            @if ($blog->Image_name != 'undefined')
                                <label for="blog-title"><img id="preview"
                    ...
                    <div class="col-md-12">
                        <textarea id="text_editor" name="text_editor" style="height: 500px">{{ $blog->blog }}</textarea>
                    </div>
                    <div class="col-md-6 mt-4">
                        <div class="blog-button">
                            <button class="submit-button" id="update">Submit</button>
                        </div>
                    </div>
